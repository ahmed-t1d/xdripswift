enum ConstantsNightScout {
    ...
    /// maximum days to upload for treatments
    ///
    /// treatments not yet uploaded and older than this timeinterval will not be uploaded
    static let maxTreatmentsDaysToUpload = TimeInterval(days: 7)
